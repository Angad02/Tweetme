...
class UserProfile(models.Model):
	...
	def get_following(self):
		users = self.following.all() # like User.objects.all()
		return users.exclude(username=self.user.username)


		# user.profile -- gives us profile for that user
		# user.profile.following -- gives us all the users that user follow
		# user.followed_by -- gives us user that follow the user(me)
